...
アプリ | 設定項目
--|--
[Visual Studio Code](https://code.visualstudio.com/) |  SettingSync入れて`⌥⇧D`で設定落とす→自動UP,DLにしとく。パレットでShellって検索→インスコ
...
アーカイブユーティリティ | プリイン。`open /System/Library/CoreServices/Applications/` 保存場所:Desktop､展開後:ゴミ箱､アーカイブのフォーマット:Zip､
[「iStat Menus」をMac App Storeで](https://itunes.apple.com/jp/app/istat-menus/id1319778037) | アクションセンターに追加
[Android File Transfer](https://www.android.com/filetransfer/) | AndroidとMacでファイル転送
[Kap](https://getkap.co/) |
[Lyrical](https://itunes.apple.com/jp/app/lyrical/id924743736) | 
